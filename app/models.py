...
from sqlalchemy import Column, String, Boolean, Enum, DateTime, Date, Time, ForeignKey, JSON, text, Integer
...
class User(Base):
    ...
    requests = relationship("ShiftRequest", back_populates="user")
